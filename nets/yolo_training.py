...
class YOLOLoss(nn.Module):
    ...
    def __call__(self, predictions, targets, imgs):
        #----------------------------------------------------------#
        #   Permute the input predictions
        #   batch_size*255*20*20 -> batch_size*3*20*20*85
        #   batch_size*255*40*40 -> batch_size*3*40*40*85
        #   batch_size*255*80*80 -> batch_size*3*80*80*85
        #----------------------------------------------------------#
        for i in range(len(predictions)): # len(predictions) == 3 ??
        ...
        # Init three part of loss function, set all numbers in matrix to zero
        ...
        # Calculate loss function of three features seperately
